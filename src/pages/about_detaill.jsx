          ...
          <div className="content">
            <section className="profile-section">
              ...
              <div className="hobbies-section">
                <h2>趣味・特技</h2>
                <p>
                  趣味は、ゲーム、駅伝観戦、ランニングです。ランニングはフルマラソンも完走した経験があります。大学駅伝も好きで、有名大学の選手の持ちタイムや成績を把握しています。また、ゲームは特にドラクエが好きで、コツコツレベル上げをしていくのに楽しみを感じます。
                </p>
                <p>
                  特技は三段跳です。高校時代に3年間取り組んでおり、日々の鍛錬と分析を重ねた結果、1cmでも記録が伸びた時はとても感動しました。
                </p>
              ...
              <div className="strengths-section">
                ...
                <div className=" strength">
                  <h3>柔軟性がある</h3>
                  <p>
                    自分の考えに固執せず他者の意見で良いと思ったものは積極的に取り入れるようにしています。まずは試してみて、より効率良く作業が出来るようにする事を心掛けています。この強みは学習にも生かされており、より効率的に作業が出来るツール等を積極的に取り入れています。
                  </p>
                </div>
                <div className="strength">
                  <h3>物事を継続出来る</h3>
